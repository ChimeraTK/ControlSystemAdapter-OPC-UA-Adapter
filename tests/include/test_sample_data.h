...
struct TestFixturePVSet {
  ...
  TestFixturePVSet() : pvManagers(createPVManager()),csManager(pvManagers.first), devManager(pvManagers.second){
	...
	// Testset
	ProcessArray<int8_t>::SharedPtr intA8dev = devManager->createProcessArray<int8_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "int8Scalar", 1, "Einheit", "Beschreibung der Variable");
	ProcessArray<uint8_t>::SharedPtr intAu8dev = devManager->createProcessArray<uint8_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "uint8Scalar", 1);
	...
	ProcessArray<int32_t>::SharedPtr intA3devMap = devManager->createProcessArray<int32_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Dein/Name/ist/int32Scalar", 1);
	ProcessArray<uint32_t>::SharedPtr intAu32devMap = devManager->createProcessArray<uint32_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Mein/Name/ist/uint32Scalar", 1);
	...
	ProcessArray<double>::SharedPtr doubledevMap = devManager->createProcessArray<double>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Dieser/Name/ist/doubleScalar", 1);
    
	ProcessArray<int8_t>::SharedPtr intB15A8devMap = devManager->createProcessArray<int8_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Mein/Name_ist#int8Array_s15", 15, "Einheit", "Beschreibung der Variable");
	ProcessArray<uint8_t>::SharedPtr intB10Au8devMap1 = devManager->createProcessArray<uint8_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Dein/Name/ist/uint8Array_s10", 10);
	ProcessArray<int16_t>::SharedPtr intB10Au16devMap2 = devManager->createProcessArray<int16_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Unser/Name/ist_int16Array_s10", 12);
	ProcessArray<uint16_t>::SharedPtr intB10Au8devMap2 = devManager->createProcessArray<uint16_t>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "Unser/Name/ist_uint8Array_s10", 10, "Einheit", "Beschreibung der Variable");
	...
	ProcessArray<float>::SharedPtr intB10Addev = devManager->createProcessArray<float>(ChimeraTK::SynchronizationDirection::controlSystemToDevice, "floatArray_s101234", 10);
	}
};
