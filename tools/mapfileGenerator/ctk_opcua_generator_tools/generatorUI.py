...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logLevelComboBox = QtWidgets.QComboBox(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "LogLevel:"))
        self.logLevelComboBox.setCurrentText(_translate("MainWindow", "TRACE"))
        self.logLevelComboBox.setItemText(0, _translate("MainWindow", "TRACE"))
        self.logLevelComboBox.setItemText(1, _translate("MainWindow", "DEBUG"))
        self.logLevelComboBox.setItemText(2, _translate("MainWindow", "INFO"))
        self.logLevelComboBox.setItemText(3, _translate("MainWindow", "WARNING"))
        self.logLevelComboBox.setItemText(4, _translate("MainWindow", "ERROR"))
        self.logLevelComboBox.setItemText(5, _translate("MainWindow", "FATAL"))
