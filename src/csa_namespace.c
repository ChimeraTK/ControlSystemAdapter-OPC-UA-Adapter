...
static UA_StatusCode csa_namespace_add_additional_variable(UA_Server *server){
  ...
  UA_NodeId parentNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_BASEVARIABLETYPE);
  ...
  return UA_Server_addVariableTypeNode(server, nodeId, parentNodeId, parentReferenceNodeId, nodeName, typeDefinition, attr, NULL, NULL);
}
