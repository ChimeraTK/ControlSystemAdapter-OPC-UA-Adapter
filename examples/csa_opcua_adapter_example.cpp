...
int main() {
	 ...
	 */
        ...
        ProcessArray<uint32_t>::SharedPtr intAu32dev = devManager->createProcessArray<uint32_t>(
        ...
        ProcessArray<int16_t>::SharedPtr intB15A16dev =
            devManager->createProcessArray<int16_t>(SynchronizationDirection::controlSystemToDevice, "int16Array_s15",
                15, "Iatrou", "Beschreibung eines Iatrous");
		...
		for(int32_t i=1000; i < 65535; i=i+1000) {
			...
			string nameInt = "testIntArray_" + to_string(i);
                        ProcessArray<double>::SharedPtr testDoubleArray = devManager->createProcessArray<double>(
                            SynchronizationDirection::deviceToControlSystem, nameDouble, i);
                        ProcessArray<int32_t>::SharedPtr testIntArray = devManager->createProcessArray<int32_t>(
                            SynchronizationDirection::deviceToControlSystem, nameInt, i);
